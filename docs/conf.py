...
source_suffix = '.rst'
master_doc = 'index'
project = 'Dikis: a dictionary'
year = str(datetime.datetime.now().year)
author = 'Alejandro Gallo'
copyright = '{0}, {1}'.format(year, author)
version = release = dikis.__version__

pygments_style = 'sphinx'
extlinks = {
    'issue': ('https://github.com/alejandrogallo/dikis/issues/%s', '#'),
    'pr': ('https://github.com/alejandrogallo/dikis/pull/%s', 'PR #'),
}
